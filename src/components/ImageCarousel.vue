<template>
  <div class="w-full flex flex-col items-center p-5">
    <div class="h-full w-3/4 relative overflow-hidden rounded-2xl">
      <!-- Carousel Images -->
      <div
    ...
    <div class="font-inter w-3/4">
      <div class="mt-5 text-4xl font-bold tracking-wide uppercase text-green-950">
        Pickleball Court
      </div>
      ...
      <div class="flex flex-row mt-5 gap-2.5">
        <div
          class="w-fit bg-amber-100 px-5 py-0.5 text-xs rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ease-in-out cursor-pointer hover:bg-amber-300"
        >
          House Rules
        </div>
        <div
